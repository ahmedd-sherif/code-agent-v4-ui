"""
Code Agent - Groq Llama 3.3 70B Version (Most Capable)
"""
...
SYSTEM_INSTRUCTION = """You are an expert AI coding assistant (Llama 3.3 70B on Groq - Most Capable).
...
root_agent = Agent(
    ...
    description="Code Agent - Groq Llama 70B (Powerful)",
